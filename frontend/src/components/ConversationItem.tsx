  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        {/* Avatar */}
        <div className={`w-12 h-12 rounded-full bg-gradient-to-br ${getAvatarColor(conversation.other_user.username)} flex items-center justify-center text-white font-bold flex-shrink-0`}>
