  ...
  return (
    <div className="flex h-screen bg-gray-900 text-white overflow-hidden">
      ...
      <div className="w-80 flex-shrink-0 flex flex-col border-r border-gray-700 bg-gray-800">
        ...
        <div className="p-4 border-b border-gray-700">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`p-2 hover:text-white hover:bg-gray-700 rounded-lg transition ${showSearch ? 'text-blue-400 bg-gray-700' : 'text-gray-400'}`}
        ...
        {showSearch ? (
          <SearchMessages onClose={() => setShowSearch(false)} />
        ) : (
